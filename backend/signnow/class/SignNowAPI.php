...
class SignNow {
	...
	public static $template_id = "0242d589631498398275530830eb521d532b86a2";


	public $User_2_Email = "";
	public $User_1_Email = "";
	public $User_1_Password = "";
	public $clientID;
	...
	public function __construct() {
		...
		// $this->User_1_Email = 'luke@weesedesigns.com'; // API TRIAL

		/* TRIAL API account */
		$this->clientID = '1663639c5b310a954028620080810766';
		
		$client_secret = '066e14d8e2d386620c4674dfb1fa592b';
		...
		$this->User_1_Email = 'olorsitametco@gmail.com'; // Your To email and Signer Token email goes here.

		$this->User_2_Email = 'finibuseleifend@gmail.com'; // Your From and main account email goes here.

		$this->User_1_Password = '77732YounggP';
	...
	public function getUserAccessToken() {
		...
		$username = $this->User_1_Email;
		$grant_type = "password";
		$password = $this->User_1_Password;
	...
	public function inviteUserToSignDocument ($document, $email) {
		...
		$header     = array("Accept: application/json", "Authorization: Bearer ".$this->clientToken);
		$parameters = json_encode(array("from"=>$this->User_2_Email,"to"=>$email));
		return self::makeCurlRequest ($url, $header, $parameters, true);
	}
